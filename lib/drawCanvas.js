...
function drawTemplateRojo(ctx, W, H, img, { productName, currentPrice, oldPrice, currency, badgeText }, logo, pos) {
  ...
  ctx.font=`italic 400 ${H*0.029}px Georgia,serif`; ctx.fillStyle='rgba(255,255,255,0.6)';
  ctx.textAlign='center'; ctx.fillText('¡No te lo pierdas! Oferta por tiempo limitado',W*0.5,H*0.775);
...
function drawTemplateVerde(ctx, W, H, img, { productName, currentPrice, oldPrice, currency, badgeText }, logo, pos) {
  const CUR = currency || 'Gs.';
...
function drawTemplateAzul(ctx, W, H, img, { productName, currentPrice, oldPrice, currency, badgeText }, logo, pos) {
  const CUR = currency || 'Gs.';
...
function drawTemplateNaranja(ctx, W, H, img, { productName, currentPrice, oldPrice, currency, badgeText }, logo, pos) {
  const CUR = currency || 'Gs.';
...
function drawTemplateMinimal(ctx, W, H, img, { productName, currentPrice, oldPrice, currency, badgeText }, logo, pos) {
  const CUR = currency || 'Gs.';
...
function drawNeonPink(ctx,W,H,img,{productName,currentPrice,oldPrice,currency,badgeText},logo,pos) {
  const CUR=currency||'Gs.';
...
function drawNeonCyan(ctx,W,H,img,{productName,currentPrice,oldPrice,currency,badgeText},logo,pos) {
  const CUR=currency||'Gs.';
...
function drawNeonPurple(ctx,W,H,img,{productName,currentPrice,oldPrice,currency,badgeText},logo,pos) {
  const CUR=currency||'Gs.';
...
function drawNeonOrange(ctx,W,H,img,{productName,currentPrice,oldPrice,currency,badgeText},logo,pos) {
  const CUR=currency||'Gs.';
...
function drawNeonGreen(ctx,W,H,img,{productName,currentPrice,oldPrice,currency,badgeText},logo,pos) {
  const CUR=currency||'Gs.';
...
function drawNeonGold(ctx,W,H,img,{productName,currentPrice,oldPrice,currency,badgeText},logo,pos) {
  const CUR=currency||'Gs.';
...
function drawPastelRosa(ctx,W,H,img,{productName,currentPrice,oldPrice,currency,badgeText},logo,pos) {
  const CUR=currency||'Gs.';
...
function drawPastelMenta(ctx,W,H,img,{productName,currentPrice,oldPrice,currency,badgeText},logo,pos) {
  const CUR=currency||'Gs.';
...
function drawPastelLavanda(ctx,W,H,img,{productName,currentPrice,oldPrice,currency,badgeText},logo,pos) {
  const CUR=currency||'Gs.';
...
function drawPastelDurazno(ctx,W,H,img,{productName,currentPrice,oldPrice,currency,badgeText},logo,pos) {
  const CUR=currency||'Gs.';
...
function drawPastelCielo(ctx,W,H,img,{productName,currentPrice,oldPrice,currency,badgeText},logo,pos) {
  const CUR=currency||'Gs.';
...
function drawPastelLimon(ctx,W,H,img,{productName,currentPrice,oldPrice,currency,badgeText},logo,pos) {
  const CUR=currency||'Gs.';
...
export async function renderToCanvas(canvas, { templateId, imageUrl, productName, currentPrice, oldPrice, logoPosition = 'center', currency = 'Gs.', badgeText = '', drawWidth, drawHeight }) {
  ...
  template.draw(ctx, W, H, img, { productName, currentPrice, oldPrice, currency, badgeText }, logo, logoPosition);
}
